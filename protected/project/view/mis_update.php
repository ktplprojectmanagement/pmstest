                       ...
                       $(function(){
                        ...
                        $('#state').change(function(){
                            ...
                            $.ajax({
                                 ...
                                 type :'post',
                                 data : state_name,
                                 url : base_url+'/kritvapms/index.php/MIS/city_list',
  ...
  <script>
        ...
        if($('#fname').val()==""){
            ...
            var pers_data = {
                ...
                $.ajax({
                                ...
                                'datatype' : 'html',
                                'data' : pers_data,
                                'url' : base_url+'/kritvapms/index.php/MIS/Save',
                                success : function(data)
                                {
                                    alert(data);
                                }
    ...
    $('#genrl_info').click(function(){
        ...
        if($('#pos_code').val()==""){
            ...
            $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : genrl_detls,
                    'url' : base_url+'/kritvapms/index.php/MIS/genrl_info',
                    success : function(data)
                    {
                        alert(data);
                    }
    ...
    $("#reprt_detls").click(function(){
        ...
        if(report_mgr_sap == ""){
            ...
            $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : reprt_data,
                    'url' : base_url+'/kritvapms/index.php/MIS/report_info',
                    success : function(data)
                    {
                        alert(data);
                    }
        ...
        if(prev_emplyr==''){
           ...
           $('#tot_exp').focus(); 
            ...
            $.ajax({
                ...
                'datatype' : 'html',
                'data' : join_details,
                'url' : base_url+'/kritvapms/index.php/MIS/join_details',
                success : function(data)
                {
                    alert(data);
                }
    ...
    $("#promo_detals").click(function(){
        ...
        if($('#err').text()==''){
                ...
                'datatype' : 'html',
                'data' : promo_details,
                'url' : base_url+'/kritvapms/index.php/MIS/promo_details',
                success : function(data)
                {
                    alert(data);
                }
    ...
    $('#trans_dtls').click(function(){
        ...
        if($('#err').text()==''){
            ...
            $.ajax({
                ...
                'datatype' : 'html',
                'data' : trans_details,
                'url' : base_url+'/kritvapms/index.php/MIS/trans_details',
                success : function(data)
                {
                    alert(data);
                }
           ...
           if($('#err').text()==''){
            ...
            var leave_details = {
                ...
                $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : leave_details,
                    'url' : base_url+'/kritvapms/index.php/MIS/leave_details',
                    success : function(data)
                    {
                        alert(data);
                    }
    ...
    $('#save_data').click(function(){
        ...
        if(cost_center == ""){
            ...
            $.ajax({
                ...
                'datatype' : 'html',
                'data' : othr_details,
                'url' : base_url+'/kritvapms/index.php/MIS/other_details',
                success : function(data)
                {
                    alert(data);
                }
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane" id="tab_1_3">
                                                                 <form action="#" class="form-horizontal">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <?php if(isset($employee_data['0']['cluster_name']) && $employee_data['0']['Reporting_Mgr_SAP_Code']==""){ ?>
