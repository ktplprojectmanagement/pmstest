                ...
                <div id="err" style="display:none"></div>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <label id="loc_nm"><?php  echo "Taloja"; ?></label>
                            <li>
                            ...
                            <div class="page-content-col">
                               ...
                               <style type="text/css">
                                ...
                                <div class="col-md-6" style="float: left;margin-top: -52px;">
                                    <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/MIS_loc" class="nav-link nav-toggle"><input type='button' id="import_csv" class="btn sbold blue" value='New Employee' ></a>
                                </div>
