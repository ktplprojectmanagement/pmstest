                       ...
                       $(function(){
                        ...
                        $('#state').change(function(){
                            ...
                            $.ajax({
                                 ...
                                 type :'post',
                                 data : state_name,
                                 url : base_url+'/kritvapms/index.php/MIS_loc/city_list',
  ...
  <script>
        ...
        if($('#fname').val()==""){
            ...
            var pers_data = {
                ...
                $.ajax({
                                ...
                                'datatype' : 'html',
                                'data' : pers_data,
                                'url' : base_url+'/kritvapms/index.php/MIS_loc/Save',
                                success : function(data)
                                {
                                    alert(data);
                                }
    ...
    $('#genrl_info').click(function(){
        ...
        if($('#pos_code').val()==""){
            ...
            $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : genrl_detls,
                    'url' : base_url+'/kritvapms/index.php/MIS_loc/genrl_info',
                    success : function(data)
                    {
                        alert(data);
                    }
    ...
    $("#reprt_detls").click(function(){
        ...
        if(report_mgr_sap == ""){
            ...
            $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : reprt_data,
                    'url' : base_url+'/kritvapms/index.php/MIS_loc/report_info',
                    success : function(data)
                    {
                        alert(data);
                    }
        ...
        if(prev_emplyr==''){
           ...
           $('#tot_exp').focus(); 
            ...
            $.ajax({
                ...
                'datatype' : 'html',
                'data' : join_details,
                'url' : base_url+'/kritvapms/index.php/MIS_loc/join_details',
                success : function(data)
                {
                    alert(data);
                }
    ...
    $("#promo_detals").click(function(){
        ...
        if($('#err').text()==''){
                ...
                'datatype' : 'html',
                'data' : promo_details,
                'url' : base_url+'/kritvapms/index.php/MIS_loc/promo_details',
                success : function(data)
                {
                    alert(data);
                }
    ...
    $('#trans_dtls').click(function(){
        ...
        if($('#err').text()==''){
            ...
            $.ajax({
                ...
                'datatype' : 'html',
                'data' : trans_details,
                'url' : base_url+'/kritvapms/index.php/MIS_loc/trans_details',
                success : function(data)
                {
                    alert(data);
                }
           ...
           if($('#err').text()==''){
            ...
            var leave_details = {
                ...
                $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : leave_details,
                    'url' : base_url+'/kritvapms/index.php/MIS_loc/leave_details',
                    success : function(data)
                    {
                        alert(data);
                    }
    ...
    $('#save_data').click(function(){
        ...
        if(cost_center == ""){
            ...
            $.ajax({
                ...
                'datatype' : 'html',
                'data' : othr_details,
                'url' : base_url+'/kritvapms/index.php/MIS_loc/other_details',
                success : function(data)
                {
                    alert(data);
                }
    ...
    $('.save_data').click(function(){
        ...
        var emp_data = {
                ...
                $.ajax({
                    ...
                    'datatype' : 'html',
                    'data' : emp_data,
                    'url' : base_url+'/kritvapms/index.php/MIS/Save_loc',
                    success : function(data)
                    {
                        alert(data);
                    }
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                                <?php 
                                                                                 ...
                                                                                 $arr_clus[$employee_data['0']['Department']] = array('selected' => true);  
                                                                                 if($employee_data['0']['Department']==""){
                                                                                    echo CHtml::activeDropDownList($cluster_name_model,'Department',$list,array('id'=>'sub_dept','class'=>'form-control Department','empty'=>'Select')); 
                                                                                 }
                                                                                 else{
                                                                                    echo CHtml::activeDropDownList($cluster_name_model,'Department',$list,array('id'=>'sub_dept','class'=>'form-control Department','options'=>$arr_clus)); 
                                                                                 }
                                                                                 ?>
...
<!--                                                                        
                         ...
                         <?php 
                                    ...
                                    <?php }?>
                                      ...
                                      //       $status1[$employee_data['0']['Reporting_1_for_appraisal']] = array('selected' => true);
                                      //       if($employee_data['0']['Reporting_1_for_appraisal']==""){
                                      //       echo CHtml::dropDownList('Reporting_officer1_id','',$Cadre_id,$htmlOptions=array('id'=>'mgr_mgr','class'=>'form-control repoting_officer','options' => $status1,'empty'=>'Select'));
                                      // }
                                      //   else{
                                      //       echo CHtml::dropDownList('Reporting_officer1_id','',$Cadre_id,$htmlOptions=array('id'=>'mgr_mgr','class'=>'form-control repoting_officer','options' => $status1)); 
                                      //     }?>  
